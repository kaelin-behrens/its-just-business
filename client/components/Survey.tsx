        ...
        <div className="survey-popup">
            {!showQuestions && 
                ...
                <div className="survey-button-container" onMouseEnter={hideNotNow} onMouseLeave={showNotNow}>
                    ...
                    <button className={hideButton ? "impossible-button" : "possible-button"}>Not now</button>
                </div>
                </div>}
            {showQuestions && 
                <div>
                    <form onSubmit={handleSubmit}>
                        ...
                        <h3>I am challenged on a daily basis at work.</h3>
                        <label htmlFor="1-sd">Strongly disagree</label><input name="rating1" id="1-sd" type="radio" required></input>
                        ...
                        <div className="survey-questions">
                        <h3>I always submit my reports on time.</h3>
                        <label htmlFor="2-sd">Strongly disagree</label><input name="rating2" id="2-sd" type="radio" required></input>
                        ...
                        <div className="survey-button-container"><button type="submit">Submit</button></div>
                    </form>
                </div>}
        </div>
        </>
